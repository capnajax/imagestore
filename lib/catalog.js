...
async function correctImages() {
  ...
  let correctionsReportInterval = setInterval(() => {
    reportCorrections();
  }, 5000);
  debug('[correctImages] correctionsReportInterval ==', correctionsReportInterval);
  ...
  clearInterval(correctionsReportInterval);
...
// automatically run correctImages on load
correctImages();
